...
class GeometryConversionTest {
    ...
    fun `test Point conversion`() {
        testPoint("POINT(2,1)", "1", "2")
        testPoint("POINT( 2,1)", "1", "2")
        testPoint("POINT(2 ,1)", "1", "2")
        testPoint("POINT(2, 1)", "1", "2")
        testPoint("POINT(2,1 )", "1", "2")

        testPoint("POINT(1 2)", "1", "2")
        testPoint("POINT( 1 2)", "1", "2")
        testPoint("POINT(1  2)", "1", "2")
        testPoint("POINT(1 2 )", "1", "2")
        testPoint("POINT(  1  2  )", "1", "2")

        testPoint("POINT(48.00692996042, 3.35239326111899)", "3.35239326111899", "48.00692996042")
        testPoint("POINT(3.35239326111899 48.00692996042)", "3.35239326111899", "48.00692996042")
        testPoint("POINT (48.00692996042, 3.35239326111899)", "3.35239326111899", "48.00692996042")
        testPoint("POINT (3.35239326111899 48.00692996042)", "3.35239326111899", "48.00692996042")
    ...
    fun `test LineString conversion`() {
        testLineString("LINESTRING(2 1,1 2)", "2 1", "1 2")
        testLineString("LINESTRING( 2 1,1 2)", "2 1", "1 2")
        testLineString("LINESTRING(2  1,1 2)", "2 1", "1 2")
        testLineString("LINESTRING(2 1 ,1 2)", "2 1", "1 2")
        testLineString("LINESTRING(2 1, 1 2)", "2 1", "1 2")
    ...
    fun `test Polygon conversion`() {
        testPolygon("POLYGON((1 1, 2 2, 3 3, 4 4))", listOf("1 1", "2 2", "3 3", "4 4"))
        testPolygon(" POLYGON( ( 1 1 , 2 2, 3 3, 4 4 ) ) ", listOf("1 1", "2 2", "3 3", "4 4"))
        testPolygon(
    ...
    fun `test GeometryCollection conversion`() {
        testGeometryCollection("GEOMETRYCOLLECTION(POINT(1 2),LINESTRING(1 2,3 4))", "POINT (1 2)", "LINESTRING (1 2, 3 4)")
        testGeometryCollection("GEOMETRYCOLLECTION(POINT(258248.054 470084.484),POLYGON((258260.95606673326 470093.9980863866,258259.69606673328 470079.71808638657,258278.59606673327 470082.2380863866,258275.23606673325 470097.7780863866,258260.95606673326 470093.9980863866)))")
    }
}

private fun testPoint(wkt: String, expectedLongitude: String, expectedLatitude: String) {
...
private fun testLineString(wkt: String, vararg expectedCoordinates: String) {
    val geoJsonGeometry = convertToGeoJsonGeometry(wkt)
...
private fun testPolygon(wkt: String, vararg expectedCoordinates: List<String>) {
    val geoJsonGeometry = convertToGeoJsonGeometry(wkt)
...
private fun testMultiPolygon(wkt: String, vararg expectedCoordinates: List<List<String>>) {
    val geoJsonGeometry = convertToGeoJsonGeometry(wkt)
...
private fun testGeometryCollection(wkt: String, vararg expected: String) {
    TODO() // ToDo
}
