...
private fun ContactStatusEntity.toContactStatus() =
    ContactStatus(
        ...
        actief = actief,
        type = when (type) {
            ContactStatusTypeEnum.NIEUW -> ContactStatusType.nieuw
            ContactStatusTypeEnum.IN_BEHANDELING -> ContactStatusType.in_behandeling
            ContactStatusTypeEnum.AFGEHANDELD -> ContactStatusType.afgehandeld
            null -> null
        }
    )
